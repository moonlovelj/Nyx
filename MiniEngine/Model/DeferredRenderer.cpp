...
void Deferred::Startup( Camera& Camera )
{
...
const ModelH3D& Deferred::GetModel()
{
    return Deferred::m_Model;
}

void Deferred::Cleanup( void )
{
    m_Model.Clear();
    Lighting::Shutdown();
...
void Deferred::RenderObjects( GraphicsContext& gfxContext, const Matrix4& ViewProjMat, const Vector3& viewerPos, eObjectFilter Filter )
{
    struct VSConstants
    {
...
void Deferred::RenderLightShadows(GraphicsContext& gfxContext, const Camera& camera)
{
