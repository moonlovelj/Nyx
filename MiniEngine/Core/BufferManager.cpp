...
void Graphics::InitializeRenderingBuffers( uint32_t bufferWidth, uint32_t bufferHeight )
{
    ...
    esram.PushStack();
        ...
        g_GBufferA.Create( L"GBufferA", bufferWidth, bufferHeight, 1, DXGI_FORMAT_R16G16B16A16_FLOAT, esram );
		...
		g_VisibilityBuffer.Create(L"Visibility Buffer", bufferWidth, bufferHeight, 1, DXGI_FORMAT_R32G32_UINT, esram);
        ...
        esram.PushStack();	// Render HDR image
            ...
            esram.PushStack(); // Begin opaque geometry
                ...
                esram.PushStack();    // Begin Shading
                    ...
                    g_ShadowBuffer.Create(L"Shadow Map", 2048 * 8, 2048 * 8, esram);
